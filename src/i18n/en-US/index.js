...
export default {
  ...
  adminHasntCreatedCategories: 'The admin hasn\'t created any complaint categories yet.',
  startManualComplaint: 'Start Manual Complaint',
  loadingComplaints: 'Loading complaints...',
  noComplaintsFound: 'No complaints found',
  startNewComplaintMessage: 'Start a new complaint to get help with any issues.',
  ...
  selectComplaintCategory: 'Select Complaint',
  chooseCategory: 'Choose Complaint',
  ...
  accountQrButton: 'Account QR',
  accountQrTitle: 'Account verification QR',
  accountQrSubtitle: 'Show this code to verify your resident account.',
  accountQrRefreshIn: 'Refreshes in {seconds}s',
  accountQrRefreshInMs: 'Refreshes in {minutes}m {seconds}s',
  accountQrClose: 'Close',
  accountQrUserMissing: 'Could not load your account data. Please try again.',
  ...
  propertyDeedContract: 'Property Deed / Contract',
  addAnotherContractDeed: '+ Add another contract / deed',
  pleaseSelectCommunityFirst: 'Please select a community first',
  ...
  forgotPasswordDesc: 'Enter your email and we\'ll send you a code to reset your password.',
  sendResetCode: 'Send Reset Code',
  resetCodeSent: 'Check your email for the reset code.',
  enterResetCode: 'Enter the 6-digit code from your email',
  newPassword: 'New Password',
  setNewPassword: 'Set New Password',
  forgotPasswordNoVerifiedEmail: 'Password reset is not available for this account because the email is not verified in our system. Please contact support to fix this.',
  ...
  frontNationalIdPictureLabel: 'Front National ID Picture',
  backNationalIdPictureLabel: 'Back National ID Picture',
  propertyDeedContractLabel: 'Property Contract / Deed',
  uploadImage: 'Upload Image',
  uploadContractDeed: 'Upload Contract/Deed',
  profilePicturePreviewAlt: 'Profile picture preview',
  frontIdPreviewAlt: 'Front ID preview',
  backIdPreviewAlt: 'Back ID preview',
  propertyContractPreviewAlt: 'Property contract preview',
  creatingAccount: 'Creating Account...',
  removeProperty: 'Remove property',
  noProjectsLoadedDebug: 'No projects loaded. Check console for errors.',
  regFailedLoadProjects: 'Failed to load projects. Please try again later.',
  regProjectAdded: 'Project added to selection!',
  regProjectUnitRequired: 'Please select a project and enter a unit number/name.',
  regProjectRemoved: 'Project removed from selection!',
  regAdditionalPropertyAdded: 'Additional property added!',
  regAdditionalPropertyFieldsRequired: 'Please fill in all fields for the additional property.',
  regWelcomeBackFinishProperty: 'Welcome back! Please select your property to finish registration.',
  regEnterEmail: 'Please enter your email address',
  regEnterPassword: 'Please enter a password',
  regPasswordMinLength: 'Password must be at least 8 characters long',
  regEmailExistsSignInInstead: 'An account with this email already exists. Please sign in instead.',
  regFailedTryAgain: 'Registration failed. Please try again.',
  regNetworkError: 'Network error. Please check your connection',
  regSelectAtLeastOneProject: 'Please select at least one project.',
  regSessionExpired: 'Registration session expired. Please start over.',
  regEmailExistsSignIn: 'An account with this email already exists. Please sign in.',
  regFailedSaveRegistration: 'Failed to save your registration. Please try again.',
  regCompleted: 'Registration completed!',
  regSomethingWentWrong: 'Something went wrong saving your registration. Please try again.',
  pdSelectImageOrPdf: 'Please select an image or PDF document',
  pdCouldNotLoadImage: 'Could not load image',
  pdInvalidImageFile: 'Invalid image file',
  pdCouldNotLoadContractFile: 'Could not load contract/deed file',
  pdFillRequiredFields: 'Please fill in all required fields',
  pdUploadFrontBackId: 'Please upload both front and back National ID pictures',
  pdUploadProfilePicture: 'Please upload a profile picture',
  pdUploadPropertyContract: 'Please upload your property contract/deed',
  pdDetailsSaved: 'Details saved!',
  pdDetailsSavedContinueProperty: 'Details saved! Continue with your property information.',
  pdDetailsSavedVerifyFace: 'Details saved! Now let\'s verify your face.',
  pdFailedToSave: 'Failed to save',
  ...
  // Onboarding Page
  languageSelectionSubtitle: 'Select a language to personalize your experience from the first step.',
  ...
  noLongerWantOrder: 'I no longer want this order',
  foundElsewhere: 'Found it elsewhere',
  foundSameItemsBetterPrice: 'Found the same items at a better price',
  deliveryIssue: 'Delivery issue',
  problemWithDeliveryTiming: 'Problem with delivery timing',
  wrongOrder: 'Wrong order',
  placedWrongOrderMistake: 'I placed the wrong order by mistake',
  priceIssue: 'Price issue',
  priceDifferentThanExpected: 'Price is different than expected',
  otherReason: 'Other reason',
  pleaseSpecifyBelow: 'Please specify below',
